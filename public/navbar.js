  ...
  $('#navbar').html(`
    ...
    <div class="btn-group">
      ...
      <div class="dropdown-menu">
          <button class="${selectedCategory === 'css/general' ? 'active' : ''} category_link dropdown-item " path="css/general" >general</button>
          <button class="${selectedCategory === 'css/frameworks' ? 'active' : ''} category_link dropdown-item " path="css/frameworks" >frameworks</button>
          <button class="${selectedCategory === 'css/icons' ? 'active' : ''} category_link dropdown-item "  path="css/icons">icons</button>
          <button class="${selectedCategory === 'css/fonts' ? 'active' : ''} category_link dropdown-item " path="css/fonts">fonts</button>
          <button class="${selectedCategory === 'css/gradients' ? 'active' : ''} category_link dropdown-item " path="css/gradients" >gradients</button>
          <button class="${selectedCategory === 'css/svgs' ? 'active' : ''} category_link dropdown-item " path="css/svgs">svgs</button>
          <button class="${selectedCategory === 'css/effects' ? 'active' : ''} category_link dropdown-item " path="css/effects">effects</button>
      </div>
    </div>
    ...
    <div class="btn-group">
      ...
      <div class="dropdown-menu">
        ...
        <button class="${selectedCategory === 'backend/mongodb' ? 'active btn-primary ' : 'btn-outline-primary '} category_link dropdown-item " path="backend/mongodb" >mongodb</button>
        <button class="${selectedCategory === 'backend/postgres' ? 'active btn-primary ' : 'btn-outline-primary '} category_link dropdown-item " path="backend/postgres" >postgres</button>
        <button class="${selectedCategory === 'backend/sql' ? 'active btn-primary ' : 'btn-outline-primary '} category_link dropdown-item "  path="backend/sql">sql</button>
    ...
    ${!loggedIn ? `<button id='login_btn' class='btn-secondary m-1'>staff login</button>` : ''}
